...
function handleCalcButtonClick() {
  ...
  const aInput = document.getElementById("input-a") as HTMLInputElement | null;
  const bInput = document.getElementById("input-b") as HTMLInputElement | null;
  const cInput = document.getElementById("input-c") as HTMLInputElement | null;
